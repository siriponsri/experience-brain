...
| EXP-03.2 | Knowledge Inbox and Dual-Memory Foundation | v0.2.3 | completed | Adds append-only `knowledge.jsonl`, inbox processing, source extractors, Knowledge dashboard views, and separated Knowledge/Experience retrieval | 22 pytest tests pass; Ruff, format, mypy, lint, dashboard startup, MCP startup, and MCP `process_inbox` pass | Better low-code source ingestion foundation; not benchmark evidence | Review and freeze the MemoryArena protocol before real inference |
